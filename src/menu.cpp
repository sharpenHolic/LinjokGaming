 ...
 * @LastEditTime: 2022-08-21 19:54:49
...
void Menu::initialSystem() 
{
    std::shared_ptr<BaseGame> marioPtr = std::make_shared<Mario>();
    m_games.AddGame(marioPtr);
}

void Menu::showOptionGameLists() 
{
    m_games.ShowGames();
}
